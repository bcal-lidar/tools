...
for a=0,nFiles-1 do begin
    ...
    ReadLAS_BCAL, inputFiles[a], header, data, records=records, versionMajor=versionMajor, versionMinor=versionMinor

        ; Update the array of records

    newRecord = RecordsToProj_BCAL(proj, versionMajor=versionMajor, versionMinor=versionMinor, /reverse)
