...
pro bcal_lidar_tools_envi52_extensions_init
  ...
  e.ADDExtension, 'Change Z Unit to LAS File(s)','ChangeZUnitLAS_BCAL', PATH='BCAL Lidar Tools/LAS File', uvalue='changeZ'
  ...
  e.AddExtension, 'Assign Vegetation Height', 'AssignVegHtLAS_BCAL', PATH='BCAL Lidar Tools', uvalue='AssignVeg'
  ...
  e.AddExtension, 'Create Raster Layer (legacy)', 'LidarRasterLAS_BCAL', PATH='BCAL Lidar Tools', uvalue='raster_legacy'
