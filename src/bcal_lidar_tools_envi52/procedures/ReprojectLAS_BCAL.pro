...
;       Modified the logic of updating the array of records, April 2016.
;
;###########################################################################
;
; LICENSE
...
for a=0,nFiles-1 do begin
    ...
    newRecord = RecordsToProj_BCAL(oProj, versionMajor=versionMajor, versionMinor=versionMinor, /reverse)
