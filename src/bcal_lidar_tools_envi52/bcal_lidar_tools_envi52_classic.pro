...
;       Added tools of "Change Z Unit for LAS file(s)", "Assign Vegetation Height", "Normalize Elevation", April 2016
;
;###########################################################################
;
; LICENSE
...
pro bcal_lidar_tools_envi52_classic_define_buttons, buttonInfo
...
envi_define_menu_button, buttonInfo, value='Reproject LAS File(s)', event_pro='ReprojectLAS_BCAL', $
    position= 4, ref_value='LAS File', uvalue='reproject'

envi_define_menu_button, buttonInfo, value='Change Z Unit to LAS File(s)', event_pro='ChangeZUnitLAS_BCAL', $
    position= 5, separator=-1, ref_value='LAS File', uvalue='changeZUnit'
...
envi_define_menu_button, buttonInfo, value='Create Bare-earth DEM', event_pro='DEMLAS_BCAL', $
    position=3, ref_value='BCAL Lidar', uvalue='raster'

envi_define_menu_button, buttonInfo, value='Assign Vegetation Height', event_pro='AssignVegHtLAS_BCAL', $
    position=4, ref_value='BCAL Lidar', uvalue='vegheight'

  envi_define_menu_button, buttonInfo, value='Normalize Elevation', event_pro='NormalizeElevLAS_BCAL', $
    position=5, ref_value='BCAL Lidar', separator=-1, uvalue='normalizeEl'
...
pro bcal_lidar_tools_envi52_classic, event 
