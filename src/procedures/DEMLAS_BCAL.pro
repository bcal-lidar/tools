...
; PURPOSE:
;
;       The purpose of this program is to bare-earth digital terrain model from 
;       height-filtered LiDAR .las file. The resolution, projection, and NoData 
;       value of the raster products are set by the user, and the data can be subset 
;       geographically or by return number.  The user can also choose to interpolate 
;       data gaps. Some of the products assume that the data has been filtered to calculate
;       vegetation heights through the HeightLAS.pro program.
;
; PRODUCTS:
;
;       The mean bare earth elevation (data elevation minus vegetation height)
;       within each pixel
;
; AUTHOR:
;
...
products = {bareElev   :{title:'Bare Earth Elevation',               points:1, index:-1, doIt:0}}
...
gridBase = widget_auto_base(title='DEM Parameters')
