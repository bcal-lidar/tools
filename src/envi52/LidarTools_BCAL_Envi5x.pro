...
pro LidarTools_BCAL_Envi5x_extensions_init
  ...
  e.AddExtension, 'Change Z Unit to LAS File(s)', 'ChangeZUnitLAS_BCAL', PATH='BCAL LiDAR Tools/LAS File', uvalue='changeZUnit'
  ...
  e.AddExtension, 'Assign Vegetation Height', 'AssignVegHtLAS_BCAL', PATH='BCAL LiDAR Tools', uvalue='vegheight'
  e.AddExtension, 'Normalize Elevation', 'NormalizeElevLAS_BCAL', PATH='BCAL LiDAR Tools', uvalue='normalizeEl'
